...
const STATE_ORDER = ['मध्यप्रदेश', 'उत्तरप्रदेश', 'नेपाळ', 'बिहार', 'महाराष्ट्र'];
          ...
          >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-orange-100 text-[11px] font-semibold">जय आनंद यात्रा</p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-3 divide-x divide-gray-100 border-t border-gray-100 bg-gray-50 shrink-0">
              {[
                ...
                { icon: <Map size={14} />,    label: 'राज्ये',      value: '5' },
